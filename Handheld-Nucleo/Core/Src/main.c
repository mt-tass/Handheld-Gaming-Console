...
#define MPU_LED_PORT GPIOC
#define MPU_LED_PIN GPIO_PIN_1
#define JOYSTICK_X_ADC_CHANNEL ADC_CHANNEL_15
#define JOYSTICK_Y_ADC_CHANNEL ADC_CHANNEL_8
...
volatile bool snake_first_draw = true;
